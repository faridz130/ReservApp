...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="font-sans text-gray-900 antialiased">
        <div class="bg-slate-100 shadow-md" x-data="{ isOpen: false }">
            <nav class="container px-6 py-8 mx-auto md:flex md:justify-between md:items-center">
              <div class="flex items-center justify-between">
                <a class="text-xl font-bold text-transparent bg-clip-text bg-yellow-400 md:text-2xl hover:text-black"
                  href="#">
                  Alam Sunda
                </a>
                <!-- Mobile menu button -->
              ...
              <div :class="isOpen ? 'flex' : 'hidden'"
                ...
                <a class="text-transparent bg-clip-text bg-yellow-500 hover:text-black"
                  href="/">Beranda</a>
                <a class="text-transparent bg-clip-text bg-yellow-500 hover:text-black"
